...
from ThreeD_affs_from_2d_affs_long_range.model import AffsUNet
...
def predict(
    ...
    input_arr = open_ds(input_datasets[0])
    ...
    input_affs_ds = open_ds(input_datasets[0], "r")

    voxel_size = input_affs_ds.voxel_size
